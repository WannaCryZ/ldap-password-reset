...
//LDAP配置
define('LDAP_SERVER', "ldap://xxx.xxx.xxx.xxx:389"); //服务器地址
define('LDAP_ADMIN_DN', 'cn=admin,dc=example,dc=com'); //管理员DN
define('LDAP_ADMIN_PASSWORD', 'LDAPADMINPASSWORD'); //管理员密码
define('LDAP_BASE_DN', 'ou=demo,dc=example,dc=com'); //搜索DN
...
define('RESET_LINK', 'http://it.example.com/ldap_manage/');//填写默认服务器地址
